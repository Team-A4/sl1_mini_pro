<?php 
    ...
    if(isset($_GET['user_username'])) {
        ...
        $query = "SELECT user_username from users where user_email = '$user_email'; ";
    ...
    if($run_select_search_query){
        ...
        $from_loc1 = isset($search_arrays[0][0]) ? $search_arrays[0][0] : '-';
        $from_loc2 = isset($search_arrays[1][0]) ? $search_arrays[1][0] : '-';
        $from_loc3 = isset($search_arrays[2][0]) ? $search_arrays[2][0] : '-';

        $to_loc1 = isset($search_arrays[0][1]) ? $search_arrays[0][1] : '-';
        $to_loc2 = isset($search_arrays[1][1]) ? $search_arrays[1][1] : '-';
        $to_loc3 = isset($search_arrays[2][1]) ? $search_arrays[2][1] : '-';        
...
<body>
    ...
    <main style="padding-top: 40px;" >
        <div class="container ">
        <div class="input-field right" style = "margin-right:7em">
                            <button class="btn white lighen-1" style="border: 2px solid black"> <a href="update_profile.php" style= "text-decoration: none ; color:black ">Update Your Profile </a></button>
        </div>
            <div class="row">
                <div class="col s12 m12 l10 offset-l1">
                    <div class="card horizontal" style="border: rgb(255, 208, 0) 1px solid;">
                      <div class="card-image">
                        <img src="./img/img_user.jpg" style="height: 300px;width: 300px;border-radius: 300px;margin-top:100px;margin-left: 2vw;border: rgb(255, 217, 0) 2px solid;">
                      </div>
