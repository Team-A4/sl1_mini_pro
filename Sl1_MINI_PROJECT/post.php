            ...
            <nav class="navbar-wrapper grey lighten-2">
                <div class="container">
                    ...
                    <ul class="right hide-on-med-and-down">
                        ...
                        <li><a href="view_profile.php" class="grey-text text-darken-4">View Profile</a></li>
                    ...
                    <?php 
                            ...
                            {   
                                ...
                                else
                                {
                                    ...
                                    $search_qq="SELECT * from post where from_location='$from_location' AND to_location='$to_location' AND date_departure = '$date_departure' AND date_arrival='$date_arrival' ; " ;    
                                    ...
                                    if($num_rows==0)
                                    {
                                        ...
                                        {
                                            $findquery= "SELECT trip_id from post where from_location= '$from_location' and to_location='$to_location' and stopover_location='$stopover_location' and date_departure = '$date_departure';";
                                               $runfindquery=mysqli_query($conn, $findquery);
                                               $arr = mysqli_fetch_array($runfindquery);
                                               $trip_id = $arr[0];

                                           if($seats > 0 )      //Companion
                                           {
                                               
                                               $insert_comp_query = "INSERT into comp values ('$active_user_username',$seats,$fare,$mode,$trip_id);";
                                           ...
                                           {
                                                    $insert_comp_query= "INSERT into comp values ('$active_user_username','0','-1',$mode,$trip_id);";
                                                    $runn=mysqli_query($conn,$insert_comp_query);
                                                    if($runn)
                                                        echo " <script>alert('Trip posted succesfully!') </script>";
                                            ...
                                            echo " <script>alert('Can not Insert') </script>";
                                        }
                                    }else{
