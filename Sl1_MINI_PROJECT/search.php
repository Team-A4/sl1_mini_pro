                        ...
                        if(isset($_POST['submit'])){
                            ...
                            if($run_search_location_query){
                                ...
                                for($index=0 ;$index < $num_rows ; $index++ ){
                                    ...
                                    $user_stopover_location = isset($result_arrays[$index]['stopover_location']) ? $result_arrays[$index]['stopover_location'] : '-';


                                    $user_mode = isset($result_arrays[$index]['mode']) ? $result_arrays[$index]['mode'] : '-';
                            ...
                            <div class='row'>
                                    <div class='col s12 '>
                                        ...
                                        <div class='card-stacked'>
                                            ...
                                            <div class='divider yellow darken-3'> </div>
                                            <div style="padding-top: 15px;padding-left: 2vw" >Empty Seats: <?php if(isset($seats[0])){ echo"$seats[0]"; }else echo"  -"; ?> <span style="padding-left: 15vw;"> Fare per Head: <?php if(isset($fare[0])){ print_r($fare[0]); } else echo"  -"; ?> </span></div>  
